function Ratings() {
    return (
        <div className="w-full flex flex-row md:flex-row max-sm:flex-col items-center justify-around gap-12 max-sm:gap-4 py-12 md:py-16 px-6 max-sm:px-2 max bg-linear-to-r from-violet-600 to-indigo-600 mb-6">
